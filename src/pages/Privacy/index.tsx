export const Privacy = () => {
  return (
    <div>
      ...
      <p>
        A sua privacidade é importante para nós. É política da JDKClean
      ...
      <h2>Política de Cookies JDKClean</h2>
      ...
      <p>
        ...
        informação que o JDKClean oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          ...
          (softwares) do JDKClean, de seus fornecedores ou terceiros,
