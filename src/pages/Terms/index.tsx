export const Terms = () => {
  return (
      <div>
        <h2>1. Termos</h2>
        <p>
          Ao acessar ao site JDKClean, concorda em cumprir estes termos
        ...
        <p>
          ...
          materiais (informações ou software) no site JDKClean , apenas
        ...
        <p>
          ...
          dessas restrições e poderá ser rescindida por JDKClean a
        ...
        <ol>
          <li>
            Os materiais no site da JDKClean são fornecidos 'como estão'.
            JDKClean não oferece garantias, expressas ou implícitas, e,
          ...
          <li>
            Além disso, o JDKClean não garante ou faz qualquer
        ...
        <h2>4. Limitações</h2>
        <p>
          Em nenhum caso o JDKClean ou seus fornecedores serão
          ...
          decorrentes do uso ou da incapacidade de usar os materiais em Quitanda
          Online, mesmo que JDKClean ou um representante autorizado da
          JDKClean tenha sido notificado oralmente ou por escrito da
        ...
        <p>
          Os materiais exibidos no site da JDKClean podem incluir erros
          técnicos, tipográficos ou fotográficos. JDKClean não garante
          que qualquer material em seu site seja preciso, completo ou atual.
          JDKClean pode fazer alterações nos materiais contidos em seu
          site a qualquer momento, sem aviso prévio. No entanto, JDKClean
          não se compromete a atualizar os materiais.
        </p>
        <h2>6. Links</h2>
        <p>
          O JDKClean não analisou todos os sites vinculados ao seu site e
          não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
          de qualquer link não implica endosso por JDKClean do site. O
          uso de qualquer site vinculado é por conta e risco do usuário.
        </p>
        <h3>Modificações</h3>
        <p>
          O JDKClean pode revisar estes termos de serviço do site a
        ...
        <p>
          ...
          leis do JDKClean e você se submete irrevogavelmente à
